...
function App() {
  ...
  return (
    <>
      ...
      {/* <div data-w-id="52e8b043-e2cb-1d7c-5a6f-3c81d4b9a9f2" style={{ display: 'flex', opacity: 1 }} className="page-load-wrapper"><img src="images/06-small.gif" loading="lazy" alt="pics" className="image-23" /></div> */}
      ...
      <section id="home" className="hero">
        ...
        <div className="floating-elements-container">
          <div className="fl-element v1">
            {/* <img src="images/Ellipse-1-copy-5.png" loading="lazy" alt="pics" /> */}
            </div>
          <div className="fl-element v2">
            {/* <img src="images/Ellipse-1-copy-6.png" loading="lazy" alt="pics" /> */}
            </div>
        </div>
          ...
          <div className="hero-content-wrapper">
            <div className="_2-col-grid is--hero">
              <div id="w-node-_151b762e-3975-8bd9-09a6-b15858026423-52018772" className="hero-text">
                <br />
                <br />
                <h4 className="display">Breasts
                <br />safety
                  <br />to the
                <br />moon
                </h4>
                <p className="is--hero-text">
                  SafeBreast Inu ($BREAST) is a
                  charity-oriented and community
                  focused decentralized
                  cryptocurrency with Instant rewards
                  for charities and holders 🐶
                </p>
              ...
              <div id="w-node-c5f9f19b-7168-f059-943c-ccb78b848fa7-52018772" className="hero-graphics-wrapper">
                {/* <img src="images/mainch.png" loading="lazy" alt="pics" className="kishu-tailwag is-full-height" /> */}
                {/* <img src="images/bowl2x.png" loading="lazy" sizes="(max-width: 479px) 95.99609375px, 256.9921875px" width={257} srcSet="images/bowl2x-p-500.png 500w, images/bowl2x.png 514w" alt="pics" className="dog-bowl" /> */}
            ...
            <div className="_2-col-grid bottom-padding is--sticky">
              ...
              <div id="w-node-bc539372-19b1-6802-b824-1e8e8666fcb6-52018772" className="right-col">
                ...
                <div id="telegram" data-w-id="cd9039a0-2dd2-5175-0451-9e43e496cf63" className="why-kishu-text-item">
                  ...
                  <p className="_w-414">Of all buy or sell transactions in the SafeBreast network 2% will be distributed to existing holders. That means you earn $BREAST just by holding it. Remember to go back and check our wallet once in a while vior •
We also burned 35% of total supply, so if as this wallet gets rewards the number of circulating coins will decrease </p>
      ...
      <section id="how-to-buy" data-w-id="79154066-a6be-0e91-28f5-f2df3abf15d2" className="how-to-buy">
        <div className="container-1800">
          ...
          <div data-w-id="8a60e5e9-f138-7430-05c7-8063c205bff1" data-animation-type="lottie" data-src="documents/frisbee-dog.json" data-loop={0} data-direction={1} data-autoplay={0} data-is-ix2-target={1} data-renderer="canvas" data-default-duration="2.0020019204587935" data-duration={0} className="lottie-animation-2">
          </div>


          {/* <div className="parent">
            <div className={`child_one ${scroll > 2032 ? 'step1' : scroll > 2332 ? 'step2' : ''}`}>
              <img src="images/frisbee.png" loading="lazy" width={1338} sizes="100vw" alt="pics" className="image-3" />
            </div>
          ...
          {/* <div className="dog-frisbee-wrapper">
            <div id="w-node-_82d26454-4b9c-a99d-09e5-0cacf9e7004a-52018772" data-w-id="82d26454-4b9c-a99d-09e5-0cacf9e7004a" className="frisbee-wrapper">
              <img src="images/frisbee.png" loading="lazy" width={1338} sizes="100vw" srcSet="images/frisbee-p-500.png 500w, images/frisbee-p-800.png 800w, images/frisbee-p-1080.png 1080w, images/frisbee-p-1600.png 1600w, images/frisbee-p-2000.png 2000w, images/frisbee.png 2776w" alt="pics" className="image-3" /><img src="images/Shape-4.png" loading="lazy" alt="pics" className="image-4" /></div>
            <div id="w-node-_7c27231e-b663-e33d-3c65-9b4ead67e582-52018772" data-w-id="7c27231e-b663-e33d-3c65-9b4ead67e582" className="dog-wrapper"><img src="images/ki-facer-1.png" loading="lazy" width={515} sizes="100vw" srcSet="images/ki-facer-1-p-500.png 500w, images/ki-facer-1-p-800.png 800w, images/ki-facer-1.png 1030w" alt="pics" className="image-5" /><img src="images/Shape-3.png" loading="lazy" sizes="100vw" srcSet="images/Shape-3-p-500.png 500w, images/Shape-3.png 1024w" alt="pics" className="image-6" /></div>
          </div> */}
          ...
          <div data-w-id="b83854f4-0edc-97bf-60d8-a3002264f569" className="stats-scrolling-container">
            <div className="_2-col-grid bottom-padding is--sticky">
              <div id="w-node-b83854f4-0edc-97bf-60d8-a3002264f56b-52018772" className="left-col">
                <div data-w-id="bbec4ffd-9457-b4fd-d633-2fb6ea1e88f5" className="tokenomics-image"><img src="images/eyeglasses-kishu.png" loading="lazy" sizes="(max-width: 767px) 100vw, (max-width: 991px) 452.9296875px, (max-width: 1919px) 46vw, 43vw"
                //  srcSet="images/eyeglasses-kishu-p-500.png 500w, images/eyeglasses-kishu-p-800.png 800w, images/eyeglasses-kishu-p-1080.png 1080w, images/eyeglasses-kishu.png 1516w" 
                 alt="pics" className="eyeglasses-kishu" />
      ...
      <section id="donate" className="donate">
        <div className="container-1800">
          ...
          <div className="press-logos-wrapper">
            <a id="w-node-_8d5d293f-b1a7-74ff-1732-75fc22a0ef52-52018772" href="https://www.newsweek.com/buy-kishu-inu-new-crypto-dogecoin-big-brother-1590404" target="_blank" className="press-logo-item w-inline-block"><img src="images/newsweek-logo-vector2x.png" loading="lazy" width={347} sizes="(max-width: 479px) 100vw, (max-width: 1919px) 22vw, 346.9921875px" srcSet="images/newsweek-logo-vector2x-p-500.png 500w, images/newsweek-logo-vector2x.png 694w" alt="pics" className="press-logo" /></a>
            ...
            <a id="w-node-_2f860849-106d-97cf-9d22-ef4e2a2335ee-52018772" href="https://mensbook.com/kishu-in-cryptocurrency" target="_blank" className="press-logo-item w-inline-block"><img src="images/MENSBOOK_black2x.png" loading="lazy" width={347} sizes="(max-width: 479px) 100vw, (max-width: 1919px) 22vw, 346.9921875px" srcSet="images/MENSBOOK_black2x-p-500.png 500w, images/MENSBOOK_black2x.png 694w" alt="pics" className="press-logo" /></a>
          </div>
        </div>
      </section>
      <div id="follow" className="footer">
        <div className="footer-relative-wrapper">
          <div className="footer-bg-imgs"><img src="images/Vector-Smart-Object2x.png" loading="lazy" width={380} sizes="(max-width: 479px) 100vw, 380px" srcSet="images/Vector-Smart-Object2x-p-500.png 500w, images/Vector-Smart-Object2x.png 760w" alt="pics" className="unicorn-kishu" /></div>
